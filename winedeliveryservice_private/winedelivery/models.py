...
class Station(models.Model): # [ REWRITE ] 追加
    class Meta:
        verbose_name = '駅データ'
        verbose_name_plural = '駅データ'

    id = models.CharField('駅ID',max_length=6,primary_key=True) # 'S00001'
    name = models.CharField('駅名',max_length=50)       # '喜多見'
    latitude = models.FloatField('駅緯度')
    longitude = models.FloatField('駅経度')
