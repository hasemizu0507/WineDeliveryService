...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('winedelivery', '0002_rentroom_owner'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='winedelivery.Profile', verbose_name='ユーザー情報')),
                ('rent_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='winedelivery.RentRoom', verbose_name='物件')),
            ],
            options={
