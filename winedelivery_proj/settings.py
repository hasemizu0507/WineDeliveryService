"""
Django settings for winedelivery_proj project.
...
SECRET_KEY = '4fzp91j+1l6-yvamp1oh@ejojrwhlj&r0frrfuzdn3q8)e@9v9'
...
ROOT_URLCONF = 'winedelivery_proj.urls'
...
WSGI_APPLICATION = 'winedelivery_proj.wsgi.application'
