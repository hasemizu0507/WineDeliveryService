...
from winedelivery.models import Profile, RentRoom, Cart #Cart追加
...
def list_view(request):
    ...
    return render(request, 'winedelivery/rentroom_list.html', {'rentrooms': rentrooms, 'page': page, 'last_page': paginator.num_pages})
...
def detail_view(request, rentroom_id):
    ...
    try:
        ...
        page = 1
    return render(request, 'winedelivery/rentroom_detail.html', {'rentroom': rentroom, 'page': page })
