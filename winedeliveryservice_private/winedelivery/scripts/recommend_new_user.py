...
from winedelivery.models import Profile, RentRoom, Station # [ REWRITE ]追加
pd.set_option('display.max_columns', 100)

from winedelivery.scripts.make_cross_table import * # [ REWRITE ] クロス集計表を作成する。algorithm回ではCSVを使っていたがDjangoのデータベース(db.sqlite)から読み込む
...
class RecommendNew():
    def __init__(self):
        ...
        # self.df_station = pd.read_csv("./data/station.csv") # [ REWITE ]削除
        # station.csvの中身
